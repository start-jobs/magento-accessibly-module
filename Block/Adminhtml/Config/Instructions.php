...
class Instructions extends Field
{
    ...
    public function render(AbstractElement $element)
    {
        ...
        $html .= '<a style="margin-top:15px; margin-bottom: 15px; display: inline-block;" class="action action-advanced-reports" target="_blank" href="https://ac.onthemapmarketing.com/login"><span style="padding-right: 5px;">Accessibly Dashboard</span></a>';
        $html .= '</div>';
        $html .= '<ol style="padding-left: 20px; font-size:15px;">';
        $html .= '<li>Create your Accessibly account by <a target="_blank" href="https://ac.onthemapmarketing.com/register">registering here</a></li>';
